# -*- coding: utf-8 -*-   [   Code 7-8 :  TF-IDF  +  LDA  +  Sentiment Analysis   +  WordCloud ]  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#
#
import pandas as pd
...
wl_space_split = " ".join(df1)
print(wl_space_split)

my_wordcloud = WordCloud(font_path=font,collocations=False, width=2400, height=2400, margin=2)  
my_wordcloud.generate_from_frequencies(frequencies=Counter(wl_space_split))
